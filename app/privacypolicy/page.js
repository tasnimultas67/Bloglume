...
const page = () => {
  return (
    <div className="my-20 p-3 rounded-md container m-auto space-y-3">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BlogLume.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BlogLume, accessible from{" "}
            <a
              href="https://bloglume.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://bloglume.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://bloglume.vercel.app/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://bloglume.vercel.app/contact
          </a>
        </li>
      </ul>
    </div>
